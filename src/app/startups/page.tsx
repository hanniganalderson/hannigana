        ...
        <div className="space-y-4 md:space-y-5">
          <div className="bg-white/95 backdrop-blur-sm shadow-lg rounded-xl p-4 md:p-6 border border-gray-200">
            <div className="space-y-2 md:space-y-3">
              ...
              >
                <span className="text-gray-700 font-medium group-hover:text-purple-700 transition-colors duration-200 text-sm md:text-base">Great Work</span>
              </a>
              ...
              <a 
                ...
                className="block p-3 md:p-4 bg-gray-50/80 hover:bg-gray-100/80 rounded-xl transition-all duration-200 group hover:shadow-sm border border-gray-200/50 hover:border-purple-300/50 /* hover:-translate-y-0.5 */"
              >
                <span className="text-gray-700 font-medium group-hover:text-purple-700 transition-colors duration-200 text-sm md:text-base">Love</span>
              </a>
              ...
              <a 
                ...
                className="block p-3 md:p-4 bg-gray-50/80 hover:bg-gray-100/80 rounded-xl transition-all duration-200 group hover:shadow-sm border border-gray-200/50 hover:border-purple-300/50 /* hover:-translate-y-0.5 */"
              >
                <span className="text-gray-700 font-medium group-hover:text-purple-700 transition-colors duration-200 text-sm md:text-base">Do Things That Don't Scale</span>
              </a>
              ...
              <a 
                ...
                className="block p-3 md:p-4 bg-gray-50/80 hover:bg-gray-100/80 rounded-xl transition-all duration-200 group hover:shadow-sm border border-gray-200/50 hover:border-purple-300/50 /* hover:-translate-y-0.5 */"
              >
                <span className="text-gray-700 font-medium group-hover:text-purple-700 transition-colors duration-200 text-sm md:text-base">Startup = Growth</span>
              </a>
              ...
              <a 
                ...
                className="block p-3 md:p-4 bg-gray-50/80 hover:bg-gray-100/80 rounded-xl transition-all duration-200 group hover:shadow-sm border border-gray-200/50 hover:border-purple-300/50 /* hover:-translate-y-0.5 */"
              >
                <span className="text-gray-700 font-medium group-hover:text-purple-700 transition-colors duration-200 text-sm md:text-base">When to Start a Startup</span>
              </a>
              ...
              <a 
                ...
                className="block p-3 md:p-4 bg-gray-50/80 hover:bg-gray-100/80 rounded-xl transition-all duration-200 group hover:shadow-sm border border-gray-200/50 hover:border-purple-300/50 /* hover:-translate-y-0.5 */"
              >
                <span className="text-gray-700 font-medium group-hover:text-purple-700 transition-colors duration-200 text-sm md:text-base">Founders - Steve Jobs Episode</span>
              </a>
            </div>
          </div>
        </div>
