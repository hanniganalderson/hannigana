  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 py-8 md:py-12 lg:py-20">
      <div className="flex flex-col gap-8 md:gap-10">
        {/* About Section */}
        <div className="flex flex-col items-center text-center gap-6 md:gap-8 p-8 md:p-12 rounded-2xl bg-white border-2 border-blue-200 shadow-lg relative overflow-hidden">
          {/* Subtle colored background */}
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-50/30 to-indigo-50/30"></div>
            ...
            <div>
              ...
              <ul className="space-y-2 md:space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700 text-sm md:text-base">real estate & investing</span>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 md:w-2.5 md:h-2.5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mt-2 flex-shrink-0"></span>
                  <span className="text-gray-700 text-sm md:text-base">systems for personal growth</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 md:w-2.5 md:h-2.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mt-2 flex-shrink-0"></span>
